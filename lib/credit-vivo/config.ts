export const creditVivoConfig = {
  ...
  productionRules: {
    ...
    complaintPacketsRequireApproval: true,
    externalSharingRequiresApproval: true,
    findingsBlockedUnlessGatesPass: true,
    lettersBlockedUnlessGatesPass: true,
    lettersBlockedUnlessVerifiedIssue: true,
    customerFinalResultBlockedWithoutQa: true,
    paymentBeforeComplianceApprovalDisabled: true,
    marketingEmailsDisabledByDefault: true,
